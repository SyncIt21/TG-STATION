...
/datum/controller/subsystem/materials/proc/to_list(datum/material_container/materials)
	. = list()
...
/datum/controller/subsystem/materials/proc/set_list(datum/material_container/materials, list/mats)
